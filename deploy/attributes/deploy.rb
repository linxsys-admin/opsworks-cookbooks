...
node[:deploy].each do |application, deploy|
  ...
  default[:deploy][application][:symlinks] = {"uploads" => "wp-content/uploads", "system" => "public/system", "pids" => "tmp/pids", "log" => "log", "uploads" => "wp-content/"}
  ...
  default[:deploy][application][:blogproxy] = 'localhost'
end
